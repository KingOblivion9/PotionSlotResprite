...
namespace PotionSlots.Content.GUI
{
    ...
    public class LifeSlot : PotionSlot
    {
        ...
        public override string Texture => "PotionSlotCal/Assets/healing_sprite";
        public override string TextureFilled => "PotionSlotCal/Assets/healingbg";
    }
    ...
    public class ManaSlot : PotionSlot
    {
        ...
        public override string Texture => "PotionSlotCal/Assets/mana_sprite";
        public override string TextureFilled => "PotionSlotCal/Assets/manabg";
    }
    ...
    public class WormholeSlot : PotionSlot
    {
        ...
        public override string Texture => "PotionSlotCal/Assets/wormhole_sprite";
        public override string TextureFilled => "PotionSlotCal/Assets/wormholebg";
    }
}
